...
const paths = {
  ...
  angular_src: 'stock-search-web-angular/dist/**/*',
  angular_dist: 'prod-build/stock-search-web-angular/dist',
...
function buildAngularCodeTask(cb) {
  ...
  return exec('cd stock-search-web-angular && npm run build', function (err, stdout, stderr) {
    log(stdout);
    log(stderr);
    cb(err);
  })
